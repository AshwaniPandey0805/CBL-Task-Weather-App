...
const weatherApi = {
    key: 'f4869762404bfa13cd1893a72ba546a3',
...
function showWeaterReport(weather) {
    ...
    <div class="weather-status">
        ...
        <div class="sunDetail">
            <div class="sunrise">
               Sunrise : ${setTiemeConversion(weather.sys.sunrise)}
            </div>
            <div class="sunset">
               Sunset : ${setTiemeConversion(weather.sys.sunset)}
            </div>
        </div>
    ...
    <div class="day-details">
        <div class="basic">
            Feels like ${weather.main.feels_like}&deg;C | Humidity ${weather.main.humidity}%  <br> Pressure ${weather.main.pressure} mb | Wind ${weather.wind.speed} KMPH</div>
    </div>
    `;
...
function setTiemeConversion(value){

    const utcDate = new Date(value * 1000); // Convert Unix timestamp to UTC Date
    const istOffset = 5.5 * 60 * 60 * 1000; // IST offset from UTC in milliseconds
    const istDate = new Date(utcDate.getTime() + istOffset); // Add IST offset to UTC Date
